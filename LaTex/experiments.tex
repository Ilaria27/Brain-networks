...
\begin{table}
	...
	\begin{tabular}{c|c|c|c|c|c}
		...
		\bottomrule
		\multirow{2}{*}{\textbf{children}}                           & b                      & 0.51 $\pm$ 0.04            & 0.55 $\pm$ 0.05    &                       & 0.46 $\pm$ 0.14                      \\ 
		\cline{2-6}
		& w                      & 0.49 $\pm$ 0.08            & 0.56 $\pm$ 0.05    &                       & 0.55 $\pm$ 0.04                      \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{adolescents}}                        & b                      & 0.53 $\pm$ 0.03            & 0.59 $\pm$ 0.07    &                       & 0.61 $\pm$ 0.05                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.53 $\pm$ 0.03            & 0.59 $\pm$ 0.07    & \multicolumn{1}{l|}{} & \multicolumn{1}{l}{0.61 $\pm$ 0.05}  \\ 
		\midrule
		\multirow{2}{*}{\textbf{eyesclosed}}                         & b                      & 0.54 $\pm$ 0.09            & 0.57 $\pm$ 0.04    &                       & 0.55 $\pm$0.05                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.54 $\pm$ 0.09            & 0.57 $\pm$ 0.04    & \multicolumn{1}{l|}{} & 0.55 $\pm$ 0.05                      \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{male}}                               & b                      & 0.51 $\pm$ 0.07            & 0.56 $\pm$ 0.02    &                       & 0.61 $\pm$ 0.02                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.51 $\pm$ 0.07            & 0.56 $\pm$ 0.02    & \multicolumn{1}{l|}{} & 0.61 $\pm$ 0.02                      \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{ABIDE}}                              & b                      & 0.52 $\pm$ 0.03            & 0.56 $\pm$ 0.01    &                       & 0.63 $\pm$ 0.04                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.52 $\pm$ 0.06            & 0.57 $\pm$ 0.05    & \multicolumn{1}{l|}{} & 0.65 $\pm$ 0.04                      \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{mta}}                                & b                      & \textbf{0.69 $\pm$ 0.03}           & 0.67 $\pm$ 0.03    &                       & 0.72 $\pm$ 0.05                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & \textbf{0.69 $\pm$ 0.02}            & 0.64 $\pm$ 0.09    & \multicolumn{1}{l|}{} & 0.69 $\pm$ 0.03                      \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{hcp\_gender}}                        & b                      & 0.53 $\pm$ 0.11            & 0.64 $\pm$ 0.08    &                       & 0.75 $\pm$ 0.03                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.53 $\pm$ 0.02            & 0.63 $\pm$ 0.02    & \multicolumn{1}{l|}{} & \textbf{0.84 $\pm$ 0.01}             \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{schizophrenia}}                      & b                      & 0.54 $\pm$ 0.05            & \textbf{0.70 $\pm$ 0.03}    &                       & 0.74 $\pm$ 0.15                      \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.51 $\pm$ 0.06            & 0.67 $\pm$ 0.01    & \multicolumn{1}{l|}{} & 0.74 $\pm$ 0.07                      \\ 
		\bottomrule
		\multicolumn{1}{l|}{\multirow{2}{*}{\textbf{mta\_cannabis}}} & b                      & 0.47 $\pm$ 0.04            & 0.58 $\pm$ 0.03    & \multicolumn{1}{l|}{} & 0.53 $\pm$ 0.10                      \\ 
		\cline{3-6}
		\multicolumn{1}{l|}{}                                        & w                      & 0.55 $\pm$ 0.10            & 0.56 $\pm$ 0.09    & \multicolumn{1}{l|}{} & 0.58 $\pm$ 0.11                      \\
		\hline
		\end{tabular}
	}
