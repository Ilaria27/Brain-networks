...
\begin{table}
	...
	\begin{tabular}{c|c|c|c|l|l}
		\multicolumn{1}{c}{}                                                         &                        & \textbf{Contrast-subgraph}        & \textbf{GraphEmbs}          & \multicolumn{1}{c|}{\textbf{Biomarkers}} & \multicolumn{1}{c}{\textbf{Graphclass}}  \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{children}}                                           & b                      & 0.51 $\pm$ 0.02  & 0.55~$\pm$ 0.02             & \multicolumn{1}{c|}{}                    & \multicolumn{1}{c}{}                     \\ 
		\cline{2-6}
		& w                      & 0.49 $\pm$    & 0.56$\pm$ & \multicolumn{1}{c|}{}                    & \multicolumn{1}{c}{}                     \\ 
		\bottomrule
		\multirow{2}{*}{\textbf{adolescents}}                                        & b                      & 0.53 $\pm$      & 0.59$\pm$ & \multicolumn{1}{c|}{}                    & \multicolumn{1}{c}{}                     \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.53 $\pm$    & 0.59 $\pm$ &                                          &                                          \\ 
		\midrule
		\multirow{2}{*}{\textbf{eyesclosed}}                                         & b                      & 0.54 $\pm$     & 0.57 $\pm$ & \multicolumn{1}{c|}{}                    & \multicolumn{1}{c}{}                     \\ 
		\cline{2-6}
		& \multicolumn{1}{l|}{w} & 0.54 $\pm$     & 0.57 $\pm$ &                                          &                                          \\ 
		\bottomrule
		...
		%\cmidrule{1-3}\cline{4-4}\cmidrule{5-6}
		\bottomrule
