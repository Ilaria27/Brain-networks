...
dir1 = "../Dataset/{}/{}/".format(args.d,args.a)
c1 = ["{}{}".format(dir1,elem) for elem in os.listdir(dir1)]


dir2 = "../Dataset/{}/{}/".format(args.d,args.b)
...
# Run Cadena et al.
subprocess.call("\"C:/Python27/python.exe\" densdp.py net.txt {}".format(args.alpha), shell = True)
